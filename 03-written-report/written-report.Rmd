...
As shown in the table above, some of the groups do not have enough data to generate model coefficients. For the model coefficients calculated, there are no significant interaction terms forthe variables investigated. Thus, there is not enough evidence to say that
...
model_with("Infant Deaths", five) %>%
  rbind(model_with("Under-five Deaths", inf)) %>%
...
12 countries, shown in the table above, have high leverage but none are influential.

The points in the first table are points with high leverage (.hat > leverage_threshold = 0.3230769) while the points in the second table are influential points (.cooksd > 0.5). 
