...
Life expectancy ranges from about 50 years to 90 years. Additionally, we see that a strong negative relationship between life expectancy and adult mortality, as well as much higher life expectancies among countries with `status` "developed" than "developing".
